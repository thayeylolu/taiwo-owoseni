...
-I used <span style="color: yellow;">github action</span>,to build a <span style="color: yellow;"> data pipeline</span> with python scripts that ingests scraped twitter data generated by [@earthquakeBot](https://twitter.com/earthquakeBot). I transformed the data (created new tables, feature extraction, data valdation, cleaning)and loaded the it into sub-folders. The loaded data is consumed by a script that creates a world map with an heat map showing the magnitude of earth quake in the world.
